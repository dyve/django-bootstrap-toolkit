...
Sinc development on Bootstrap v2 has stopped, it is safe to assume that this Django app won't receive much updates in the future. Everyone using Bootstrap is encouraged to upgrade to Bootstrap v3 and https://github.com/dyve/django-bootstrap3.
