...
urlpatterns = patterns('',
    ...
    url(r'^model_form$', 'demo_app.views.demo_model_form'),
    url(r'^form_with_template$', 'demo_app.views.demo_form_with_template'),
    url(r'^form_inline$', 'demo_app.views.demo_form_inline'),
    url(r'^form_inline_with_template$', 'demo_app.views.demo_form_inline_with_template'),
